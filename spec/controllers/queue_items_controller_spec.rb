...
describe QueueItemsController do
  ...
  describe "POST reorder" do
    ...
    it_behaves_like "requires sign in" do
      let(:action) { post 'reorder', user_id: user.id, queue: [{ "id" => queue_item_1.id, "new_position" => "1" }, { "id" => queue_item_2.id, "new_position" => "2" }, { "id" => queue_item_3.id, "new_position" => "3" }, { "id" => queue_item_4.id, "new_position" => "2" }, { "id" => queue_item_5.id, "new_position" => "5" }] }
    end
